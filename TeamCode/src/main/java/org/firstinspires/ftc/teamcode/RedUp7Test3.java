...
@Autonomous(name = "RedUp7-test3", group = "Autonomous")
@Configurable
public class RedUp7Test3 extends OpMode {
     ...
     * inside shooter.shootSlow(). If the ball that scored was around 1260, test 1260 as the target
    ...
    public static double TARGET_SHOOTER_VELOCITY = 1350;
    public static double VELOCITY_UNDER_TOLERANCE = 50; // stopper closes below target - this
