...
public class RedDown8 extends OpMode {
    ...
    public void init() {
        ...
        /*
         * Turret field angle:
         * 0 means the turret tries to face field angle 0 degrees.
         *
         * If your goal is not at field angle 0, change this value.
         * Example:
         * turret.setFieldAngle(20);
         * turret.setFieldAngle(-15);
         */
        turret.setFieldAngle(75);

        /*
         * Use this if the turret is mechanically not centered when encoder = 0.
         * Start with 0. Tune later if needed.
         */
        turret.setOffset(0);
    ...
    private void startIntakePath(PathChain path, int nextState) {
        ...
        /*
         * Intake collection direction.
         * If this is physically opposite on your robot,
         * change intake.intakeIn() to intake.intakeOut().
         */
        intake.intakeOut();
